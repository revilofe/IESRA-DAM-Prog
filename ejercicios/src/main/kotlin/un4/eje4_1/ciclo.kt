...
fun main() {
    val modulo = Modulo(15).apply {
        matricularAlumno(Alumno("1", "Eduardo", "Fernández", "Oliver"))
        matricularAlumno(Alumno("2", "Andres", "Astana", "Santana"))
        matricularAlumno(Alumno("1", "Eduardo", "Fernández", "Oliver"))
        matricularAlumno(Alumno("3", "Andrea", "Astana", "Santana"))
    }
    ...
    modulo.establecerNota("3", Modulo.EV_PRIMERA, 4.5F)
    modulo.establecerNota("3", Modulo.EV_SEGUNDA, 5.5F)
    modulo.establecerNota("3", Modulo.EV_TERCERA, 6.5F)
    modulo.establecerNota("2", Modulo.EV_PRIMERA, 5.5F)
    modulo.establecerNota("2", Modulo.EV_SEGUNDA, 2.5F)
    modulo.establecerNota("2", Modulo.EV_TERCERA, 2.5F)
